...
(function() {
  $(function() {
    ...
    defaults = {
      ...
      yesText: 'Yes',
      noText: 'No',
      modalConfirmationTemplate: '<div class="modal" data-role="confirmation"><div class="modal-content"></div><button class="modal-no"></button><button class="modal-yes"></button></div>',
